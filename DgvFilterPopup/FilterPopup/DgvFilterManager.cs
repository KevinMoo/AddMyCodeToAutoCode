...
namespace DgvFilterPopup {
    ...
    public class DgvFilterManager {
        ...
        //private MSC.CommonLib.MyDataView mBoundDataView;            // The DataView to which the DataGridView is bound
            ...
            try {
                ...
                } else 
                {
                   //editby mo 2013.9.30
                    ...
                    //if (mBoundDataView.MyRowFilter != Filter) mBoundDataView.MyRowFilter = Filter;
                }
